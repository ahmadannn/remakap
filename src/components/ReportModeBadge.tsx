...
export const ReportModeBadge: React.FC<ReportModeBadgeProps> = ({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3 rounded-2xl bg-white border border-slate-200 shadow-xs">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="inline-flex items-center p-0.5 rounded-xl bg-slate-100 border border-slate-200">
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition cursor-pointer ${activeSlot === '08.30'
            ...
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition cursor-pointer ${activeSlot === '15.30'
                ? 'bg-cyan-600 text-white shadow-xs'
      ...
      <span className="hidden sm:inline text-xs text-slate-500 font-medium text-right">
